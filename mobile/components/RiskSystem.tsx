...
export const RISK_COPY: Record<RiskBand, { head: string; sub: string; cfu: string; drops: number }> = {
  Low:         { head: "Low modeled risk.", sub: "Lower modeled exceedance risk today.",        cfu: "< 35 CFU",  drops: 1 },
  Moderate:    { head: "Moderate modeled risk.",         sub: "Elevated modeled risk today.",                 cfu: "35–104",    drops: 2 },
  High:        { head: "Elevated modeled risk.",         sub: "High modeled exceedance risk — check county advisories.",    cfu: "104–320",   drops: 3 },
  "Very High": { head: "Very high modeled risk.",   sub: "Check posted county advisory before entering.", cfu: "> 320",     drops: 3 },
};
