...
import { siteForMap } from "@/lib/curated";
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12">
          <div className="max-w-2xl">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Explore daily water quality forecasts from monitoring stations spanning 
          ...
          <div className="flex gap-8 text-sm">
            <div className="text-center">
              <div className="text-2xl font-semibold text-foreground">924</div>
              <div className="text-muted-foreground">Monitoring Stations</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-semibold text-foreground">377</div>
              <div className="text-muted-foreground">Modeled Sites</div>
            </div>
            <div className="text-center">
